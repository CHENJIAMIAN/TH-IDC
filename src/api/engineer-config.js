...
// 获取策略
export function alertStrategyQueryByLevelId(data) { return request({ url: '/admin/alert/alertStrategy/queryByLevelId', method: 'post', data }) }
// 新增策略
export function alertStrategyAddOrEdit(data) { return request({ url: '/admin/alert/alertStrategy/addOredit', method: 'post', data }) }
// 获取告警策略列表 带分页
